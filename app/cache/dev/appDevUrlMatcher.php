...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/uekdemo')) {
            if (0 === strpos($pathinfo, '/uekdemo/thread')) {
                // thread
                if (rtrim($pathinfo, '/') === '/uekdemo/thread') {
                    if (substr($pathinfo, -1) !== '/') {
                ...
                // thread_show
                if (preg_match('#^/uekdemo/thread/(?P<id>[^/]++)/show$#s', $pathinfo, $matches)) {
                ...
                // thread_edit
                if (preg_match('#^/uekdemo/thread/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                ...
                // thread_update
                if (preg_match('#^/uekdemo/thread/(?P<id>[^/]++)/update$#s', $pathinfo, $matches)) {
                ...
                // thread_delete
                if (preg_match('#^/uekdemo/thread/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
            ...
            if ($pathinfo === '/uekdemo/feed/remove') {
